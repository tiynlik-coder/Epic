...
ROLE_INTRO = {
    ...
    "Hamshira": "Siz Tinch aholi tarafdasiz. Shifokor sizga davolash natijalarini aytib turadi. Shifokor o‘lsa, uning o‘rnini siz egallaysiz.",
    ...
    "Robin Gud": "Siz Tinch aholi tarafdasiz. Har tun bir o‘yinchini o‘ldira olasiz. Ammo ikki marta tinch aholini o‘ldirsangiz, o‘z joningizga qasd qilasiz.",
    "Fotoparatchi": "Siz Tinch aholi tarafdasiz. Har tun bir o‘yinchini kuzatasiz va u tunda kimnikiga borganini rasmga olasiz.",
    "Yollanma qotil": "Siz Mafia tarafdasiz. Har tun kimnidir ovlaysiz — shifokor ham yordam bera olmaydi. Tunda sizni o‘ldirib bo‘lmaydi, Kezuvchi ham ta’sir qilmaydi. Ammo Komissarni nishonga olsangiz, u sizni o‘ldiradi.",
    "Jurnalist": "Siz Mafia tarafdasiz. Har tun kimdandir intervyu olib, uning uyiga kim kelganini bilasiz va Donga xabar berasiz.",
    "Aferist": "Siz Yakka tarafdasiz. Tunda bir o‘yinchini aldab, ertangi ovoz berishda uning nomidan ovoz berasiz. Maqsadingiz — tirik qolish.",
    ...
    "G‘azabkor": "Siz Yakka tarafdasiz. Har tun bir o‘yinchini tanlab borasiz. O‘zingizni tanlasangiz, avval tanlaganlaringiz bilan birga o‘lasiz. Kamida ikkitasini olib ketsangiz, g‘alaba qozonasiz.",
    ...
    "Qaroqchi": "Siz Yakka tarafdasiz. Tunda kimningdir pulini olasiz yoki uni do‘pposlaysiz (−50 HP). Pul topilmasa, do‘pposlaysiz. Tirik qolsangiz yutasiz.",
